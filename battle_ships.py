...
player_two_map_shot = player_two_map
player_one_map_shot = player_one_map
player_two_map_hit = player_two_map
player_one_map_hit = player_one_map
'''
...
while True:
    if display_control == "1":
        ...
        choice = input("Enter coordinate of shot: ")
    ...
    if display_control == "2":#Win
        if player_two_map_shot == player_two_map:
            print("Good Job Player Two")
            break
        if player_one_map_shot == player_one_map:
